...
const Navbar = () => {
	...
	const style = {
		...
		navTitle: `text-2xl font-bold ml-[6rem] text-transparent bg-clip-text bg-gradient-to-r from-[#003c71] to-[#0069ff]`,
		notSigned: '',
	...
	return (
		<div className={style.wrapper}>
			...
			{user ? (
				<h1 className={style.navTitle}>Now logged in as: {user}⭐</h1>
			) : (
				''
			)}
